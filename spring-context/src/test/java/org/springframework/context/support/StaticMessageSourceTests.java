...
public class StaticMessageSourceTests extends AbstractApplicationContextTests {
    ...
    protected ConfigurableApplicationContext createContext() throws Exception {
        ...
        m.put("name", "Roderick");
        parent.registerPrototype("rod", org.springframework.tests.beans.TestBean.class, new MutablePropertyValues(m));
        m.put("name", "Albert");
        parent.registerPrototype("father", org.springframework.tests.beans.TestBean.class, new MutablePropertyValues(m));
