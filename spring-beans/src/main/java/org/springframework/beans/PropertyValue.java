...
public class PropertyValue extends BeanMetadataAttributeAccessor implements Serializable {
    ...
    //值对象总是重写equals和hashCode方法,因为值对象会被用在各种集合和map中进行处理
    //值对象是指，没有太多业务逻辑，只要用来做数据的封装的对象.类似POJO
    @Override
    ...
    //参考effectiveJava#item,总是重载toString.好处是
    //1.在打日志的时候，不用再拼装参数.2.维护了类最少对外暴露，不用维护太多的get方法
    //3.通用方法，遵守java的Object的规范
    @Override
