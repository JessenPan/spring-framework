...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory
    ...
    private static final Log LOGGER = LogFactory.getLog(AbstractAutowireCapableBeanFactory.class);
    ...
    protected Object createBean(String beanName, RootBeanDefinition mbd, Object[] args) throws BeanCreationException {
        ...
        //确定beanClass已经被正确的解析出来,因为在xml里指定的是类的字符串
        //此处需要把字符串的类信息转换为java的class
     ...
     */
    private Object doCreateBean(final String beanName, final RootBeanDefinition mbd, final Object[] args) {
    ...
    private void populateBean(String beanName, RootBeanDefinition mbd, BeanWrapper bw) {
        ...
        if (bw == null) {
            //当beanWrap为空，但是beanDefinition里的pvs不为空时,抛异常!
            if (!pvs.isEmpty()) {
                throw new BeanCreationException(mbd.getResourceDescription(), beanName, "Cannot apply property values to null instance");
            } else {
                //beanWrap为空,pvs也为空时.直接跳过
                return;
            }
        }
     ...
     */
    private Object initializeBean(final String beanName, final Object bean, RootBeanDefinition mbd) {
     ...
     * @see #invokeInitMethods
     */
    private void invokeCustomInitMethod(String beanName, final Object bean, RootBeanDefinition mbd) throws Throwable {
        String initMethodName = mbd.getInitMethodName();
